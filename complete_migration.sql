...
-- AddForeignKey
ALTER TABLE "ChatMessageReadReceipt" ADD CONSTRAINT "ChatMessageReadReceipt_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;-- CreateTable
